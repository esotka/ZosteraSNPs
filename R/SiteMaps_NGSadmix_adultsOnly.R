...
pdf("output/SiteMaps_NGSadmix_adultsOnly.pdf")
...
text(x=c(-70.91525,-70.78,-70.73524,-70.65306,-71.07),
     y=c(42.39230,42.52,42.539,42.56381,42.3327),
     c("Curlew Beach","Lynch Park","West Beach","Niles Beach","Boston"))
...
# pie position
for (j in 1:4)
{floating.pie(xpos=meta$lon[j],ypos=,meta$lat[j],x=c(t(xbar[j,-1])),col=kcol,radius=0.02)}
dev.off()
