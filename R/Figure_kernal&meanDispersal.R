...
meanDispersal_out = data.frame(MAF=dat$MAF,meanDispersal,meanDispersal_L95,meanDispersal_U95)
print(meanDispersal_out)
#   MAF meanDispersal meanDispersal_L95 meanDispersal_U95
#1 0.05     0.1533226         0.1364383         0.1779283
#2 0.02     0.1299239         0.1156933         0.1508002
#3 0.01     0.1175718         0.1045229         0.1364383
#4 0.00     0.1175718         0.1045229         0.1364383
...
legend(x=1.5,y=.4,dat$MAF,fill=cols.to.use,bty = "n")
text(1.8,0.5,"MAF",cex=1.3,pos=1)

par(fig = c(.55,.95,.3,.95), new = T)
plot(meanDispersal~c(4:1),ylim=c(0,.3),type="p",xaxt="n",xlim=c(0.5,4.5),pch=20,cex.lab=0.8,xlab="",ylab="")
