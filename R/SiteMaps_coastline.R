...
segments(x0=leftPoint[1],y0=leftPoint[2],x1=rightPoint[1],y1=rightPoint[2],col="black")
text("5 km",x=(leftPoint[1]+rightPoint[1])/2,y=leftPoint[2]+0.005,cex=.8)
text(x=meta$lon,y=meta$lat+0.02,c("Curlew Beach","Lynch Park","Niles Beach","West Beach","Boston MA"))
