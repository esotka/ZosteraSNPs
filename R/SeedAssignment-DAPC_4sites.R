...
dapc2 <- dapc(adult,grp=env$site.nice,n.pca=20,n.da=100)
...
### no Lynch deep
cols.seed <- c("blue","purple","black","red")
#pch.seed <- c(1,22,22,1,22,1,22)
points(seedPredict$ind.scores,col=cols.seed[env$site.nice],cex=2)#pch=pch.seed[env$site.nice.depth],cex=2)
out <- as.matrix(table(seedPredict$assign,env$site.nice))
